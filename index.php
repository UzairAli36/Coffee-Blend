...
//	Displaying products
$products = $conn->query("SELECT * FROM products WHERE category='coffee'");
$products->execute();
		...
		<div class="container">
			<div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
				...
				<div class="col-md-8 col-sm-12 text-center ftco-animate">
					...
					<p><a href="<?php echo APPURL; ?>/menu.php" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a> <a href="<?php echo APPURL; ?>/menu.php" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a></p>
				</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="menu-entry">
							<a href="menu.php" class="img" style="background-image: url(images/menu-1.jpg);"></a>
						</div>
					</div>
					<div class="col-md-6">
						<div class="menu-entry mt-lg-4">
							<a href="menu.php" class="img" style="background-image: url(images/menu-2.jpg);"></a>
						</div>
					</div>
					<div class="col-md-6">
						<div class="menu-entry">
							<a href="menu.php" class="img" style="background-image: url(images/menu-3.jpg);"></a>
						</div>
					</div>
					<div class="col-md-6">
						<div class="menu-entry mt-lg-4">
							<a href="menu.php" class="img" style="background-image: url(images/menu-4.jpg);"></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-md-3">
					<div class="menu-entry">
						...
						<div class="text text-center pt-4">
							<h3><a target="_blank" href="products/product-single.php?id=<?php echo $product->id; ?>"><?php echo $product->name; ?></a></h3>
							<p><?php echo $product->description; ?></p>
							<p class="price"><span>$<?php echo $product->price; ?></span></p>
							<p><a target="_blank" href="products/product-single.php?id=<?php echo $product->id; ?>" class="btn btn-primary btn-outline-primary">Show Product</a></p>
						</div>
					</div>
				</div>
			...
			<?php foreach ($allReviews as $review) : ?>
				<div class="col-md-3 align-self-sm-end ftco-animate">
					<div class="testimony">
						<blockquote>
							<p>&ldquo;
								<?php echo $review->review; ?>&rdquo;</p>
						</blockquote>
