        ...
        <div class="container">
            <div class="row slider-text justify-content-center align-items-center">
                ...
                <div class="col-md-7 col-sm-12 text-center ftco-animate">
                    ...
                    <p class="breadcrumbs"><span class="mr-2"><a href="<?php echo APPURL; ?>">Home</a></span> <span>Orders</span>
                    </p>
                </div>
                            ...
                            <tbody>
                                <?php foreach ($allOrders as $order) : ?>
                                    <tr class="text-center">
                                        ...
                                        <td class="street_address"><?php echo $order->street_address; ?></td>
                                        ...
                                        <?php if ($order->status == "Delivered") : ?>
                                            <td class="status"><a class="btn btn-primary" href="<?php echo APPURL; ?>/reviews/write-review.php">Review</a></td>
                                        <?php endif; ?>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
