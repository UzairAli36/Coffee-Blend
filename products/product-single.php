...
if (isset($_GET['id'])) {
	...
	$relatedProducts = $conn->prepare("SELECT * FROM products WHERE category = :category AND id != :id");
	$relatedProducts->execute([':category' => $singleProduct->category, ':id' => $id]);
	...
	if (isset($_POST['submit'])) {
		...
		$insert_cart = $conn->prepare("INSERT INTO cart (name, image, price, pro_id, description, size, quantity, user_id) 
                                       VALUES (:name, :image, :price, :pro_id, :description, :size, :quantity, :user_id)");
	...
	if (isset($_SESSION['user_id'])) {
		$validateCart = $conn->prepare("SELECT * FROM cart WHERE pro_id = '$id' AND user_id = '$_SESSION[user_id]'");
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 mb-5 ftco-animate">
				<a href="#" class="image-popup"><img src="<?php echo APPURL; ?>/images/<?php echo $singleProduct->image; ?>" class="img-fluid" alt="Colorlib Template"></a>
			</div>
			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
				...
				<form action="product-single.php?id=<?php echo $id; ?>" method="POST">
					...
					<div class="w-100">
						<div style="padding-left: 0px;" class="input-group col-md-6 d-flex mb-3">
						...
						<script>
							...
							// Get quantity adjustment buttons
					...
					<?php if (isset($_SESSION['user_id'])) : ?>
						<?php if ($rowCount > 0) : ?>
							<button style="background: transparent;" name="submit" type="submit" class="btn btn-primary py-3 px-5" disabled>Added to Cart</button>
						<?php else : ?>
							<button style="color: black !important;" name="submit" type="submit" class="btn btn-primary py-3 px-5">Add to Cart</button>
						<?php endif; ?>
					<?php else : ?>
				...
				<div class="col-md-3">
					<div class="menu-entry">
						...
						<div class="text text-center pt-4">
							...
							<p><a href="<?php echo APPURL; ?>/products/product-single.php?id=<?php echo $allRelatedProduct->id; ?>" class="btn btn-primary btn-outline-primary">Show Product</a></p>
						</div>
					</div>
				</div>
			<?php endforeach; ?>
