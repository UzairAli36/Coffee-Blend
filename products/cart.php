		...
		<div class="container">
			<div class="row slider-text justify-content-center align-items-center">
				...
				<div class="col-md-7 col-sm-12 text-center ftco-animate">
					...
					<p class="breadcrumbs"><span class="mr-2"><a href="<?php echo APPURL; ?>">Home</a></span> <span>Cart</span>
					</p>
				</div>
							...
							<tbody>
								<?php foreach ($allProducts as $product) : ?>
									<tr class="text-center">
										...
										<td class="size"><?php echo $product->size; ?></td>
		...
		<div class="row justify-content-end">
			<div class="col col-lg-3 col-md-6 mt-5 cart-wrap ftco-animate">
				...
				<form method="POST" action="cart.php">
					...
					<?php if ($allCartTotal->total > 0) : ?>
						<button style="color: black !important;" name="checkout" type="submit" class="btn btn-primary py-3 px-4">Proceed to Checkout</button>
					<?php endif; ?>
				</form>
			</div>
		</div>
