                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    <?php if (isset($_SESSION['admin_name'])) : ?>
                        <ul class="navbar-nav side-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo ADMINURL; ?>/reviews-admins/show-reviews.php" style="margin-left: 20px;">Reviews</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo ADMINURL; ?>/users-admins/show-app-users.php" style="margin-left: 20px;">Users</a>
                            </li>
                        </ul>
                    <?php endif; ?>
